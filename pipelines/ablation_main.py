#!/usr/bin/env python3
"""
Ablation Study Main Script for SemGraph
...
Usage:
    ...
    python pipelines/ablation_main.py --decoder                # Decoder type ablation만
    python pipelines/ablation_main.py --edge-filtering         # Edge filtering ablation만
"""
...
def print_banner():
    ...
    banner = f"""
{Fore.CYAN}{'=' * 80}
{Fore.GREEN}  SemGraph Ablation Study
...
def create_base_config() -> SemGraphConfig:
    ...
    config = SemGraphConfig(
        ...
        # 출력
        save_results=True,
        output_dir="artifacts/runs/results/ablation",
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="SemGraph Ablation Study - Systematic Hyperparameter Analysis",
...
Examples:
  ...
  python pipelines/ablation_main.py --output-size --max-docs 1000
    ...
    parser.add_argument('--max-docs', type=int, default=10000,
                        help='최대 문서 수')
    parser.add_argument('--output', type=str, default='artifacts/runs/results/ablation',
                        help='출력 디렉토리')
